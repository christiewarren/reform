...
const  
      ...
      dani = new individual('danielle', 'berman', '', 'daniberman.dzn', 'daniberman.com', 'posters.gif', 'converse.gif', 'wmag.gif', 'posters.jpg', 'converse.jpg', 'wmag.jpg', "bio", 'dani', 'Sports and Entertainment Sustainability posters', 'Converse campaign', 'Irresistable Magazine'),
      ...
      taylor = new individual('taylor', 'mazzarella', 'taylor-mazzarella-b2391b181', 'tmz.dzn', 'taylormazzarella.com', 'thePost.gif', 'work2', 'critic.gif', 'thePost.jpg', 'cover2', 'critic.jpg', "Hey, what’s up? I’m Taylor! I’m looking to design comprehensive and strategic brands that pack a punch. After graduation, I hope to pursue a career in branding or motion design. <br><br>Inspired by physical touch and how our senses dictate the feeling of a composition, I created a poster to represent the importance of physicality in design.", 'taylor', 'The Post title sequence', 'work2Alt', 'Critic app'),

      tamar = new individual('tamar', 'najarian', 'tamar-najarian-7baa31180', 'bytamar_', 'tamarnajarian.com', 'snownote.gif', 'apricotTypeface.png', 'zodiac.png', 'snownote.jpg', '',  '', "Hey guys I’m Tamar! I've recently become increasingly fascinated by typography and the way its details hold so much power communicative power. I hope to pursue a career in branding where I’ll be able to create typefaces that bring an extra level of personality to whatever it is I’m creating.<br><br>Inspired by my love for typography, my poster was created by manipulating vectored letterform to create an engaging use of positive and negative space.", 'tamar', 'Snownote app', 'Apricot typeface', 'The Zodiac Collection wine branding'),
      ...
      sam = new individual('samantha', 'smith', 'samantha-smith-590b2a177', 'blueyedblony16', 'smsmth.com', 'work1', 'irirs.jpg', 'menus.jpg', 'cover1', '', '', "Hi, I'm Sam Smith (I know I'm not the only one). I am a creative little lady with an affinity for puns and wordplay.  While I am not locked down into a specific career path at this time, I am quite fond of digital design (UX/UI) and anything with illustration.<br><br>Inspired by my foundation in art and drawing, I have incorporated illustration and arts/crafts into my poster design.", 'sam', 'work1Alt', 'irirs iOS notification system redesign', 'Sowers Harvest menu'),
