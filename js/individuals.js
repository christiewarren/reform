...
const  
      ...
      dani = new individual('danielle', 'berman', '', 'daniberman.dzn', 'daniberman.com', 'posters.gif', 'converse.gif', 'wmag.gif', 'postersBW.jpg', 'converseBW.jpg', 'wmagBW.jpg', "Hello! I'm Dani, a passionate creative who aspires to communicate and storytell through design. I hope to pursue a career where I can focus on my aspirations of creating lasting impacts on an audience through decisions and engaging solutions.<br><br>My poster utilizes digital manipulation and long-exposure photography. Juxtaposing these techniques with the constraint of a grid makes an abstract, textured composition that resembles my curiosity for innovating and creating new perspectives.", 'dani', 'Sports and Entertainment Sustainability posters', 'Converse campaign', 'Irresistable Magazine'),
